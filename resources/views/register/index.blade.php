    ...
    <div class="col-lg-5">
        <main class="form-registration">
            ...
            <form action="/register" method="POST">
                ...
                <div class="form-floating">
                    <input type="password" name="password" class="form-control rounded-buttom @error('password') is-invalid @enderror" id="password" 
            ...
            <small class="d-block text-center mt-3"> Dah daftar kan?<a href="/login"> Login sini</a></small>
        </main>
    </div>
</div>
</div>
